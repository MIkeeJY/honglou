...
public class EditHistoryViewHolder extends CygBaseRecyclerViewHolder<VideoListItem> {
    @BindView(R.id.iv_detail_cover) ImageView mIvDetailCover;
    @BindView(R.id.iv_delete) ImageView mIvDel;
    ...
    public EditHistoryViewHolder(View view) {
        super(view);
